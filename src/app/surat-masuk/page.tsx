    ...
    <div className="flex flex-col min-h-full">
      <header className="h-16 border-b border-slate-300 dark:border-slate-800 bg-white/70 dark:bg-slate-950/70 backdrop-blur-md flex items-center justify-between px-6 sticky top-0 z-20">
        <div className="flex items-center gap-4">
          ...
          <h2 className="text-[11px] font-medium text-slate-400 hidden md:block tracking-tight">Koleksi Surat Masuk</h2>
        </div>
      </header>
      ...
      >
        <div className="space-y-1">
          <h1 className="typography-h1 font-semibold text-slate-900 dark:text-slate-100 tracking-tight text-emerald-600">Surat Masuk</h1>
          <p className="typography-muted text-sm font-medium">Daftar seluruh dokumen yang diterima dari pihak eksternal.</p>
        </div>
          ...
          <div className="relative min-h-[400px]">
            {isLoading ? (
              ...
              <div className="py-24 text-center">
                <Inbox className="h-10 w-10 text-slate-100 dark:text-slate-800 mx-auto mb-4" />
                <h3 className="typography-h3 text-slate-900 dark:text-slate-100 font-medium text-sm">Tidak ada surat masuk</h3>
                <p className="typography-muted font-medium text-xs">Semua surat masuk akan tampil di sini.</p>
              </div>
            )}
          </div>
        </div>
