      ...
      <div className="p-6 lg:p-10 max-w-7xl mx-auto w-full space-y-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2 space-y-4">
            ...
            <div className="border border-slate-300 dark:border-slate-800 bg-white dark:bg-slate-950 rounded-lg divide-y divide-slate-100 dark:divide-slate-800 overflow-hidden">
              {isLoading ? (
                ...
                recentLetters.map((l) => (
                  <div key={l.id} className="p-4 flex items-center justify-between hover:bg-slate-50 dark:hover:bg-slate-900 transition-colors">
          ...
          <div className="space-y-4">
            ...
            <div className="p-5 border border-slate-300 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-900/50 rounded-lg space-y-4">
...
function StatsCard({ label, value, icon }: { label: string, value: number, icon: React.ReactNode }) {
  return (
    <div className="border border-slate-300 dark:border-slate-800 bg-white dark:bg-slate-950 p-6 flex items-center justify-between rounded-lg hover:border-slate-400 dark:hover:border-slate-700 transition-colors shadow-none">
      <div className="space-y-1">
